        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">{{ $projects->where('is_featured', true)->count() }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-gray-900">
                        @if($projects->where('price', '>', 0)->count() > 0)
                            ₹{{ number_format($projects->where('price', '>', 0)->avg('price') / 100000, 1) }}L
                        @else
                            N/A
                        @endif
                    </p>
        ...
        <table id="projectsTable" class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-4">
                                <div class="flex-shrink-0">
                                    @if($project->images->count() > 0)
                                        <div class="h-12 w-12 rounded-lg overflow-hidden shadow-sm">
                                            <img class="h-full w-full object-cover" src="{{ asset($project->images->first()->image_path) }}" alt="{{ $project->title }}">
                                        </div>
                                    @else
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="text-sm font-semibold text-gray-900 truncate">{{ $project->title }}</div>
                                    <div class="text-xs text-gray-500 truncate mt-1">{{ Str::limit($project->short_description, 50) }}</div>
                                    <div class="flex items-center mt-1">
                                        <span class="text-xs text-gray-400">{{ $project->created_at->format('M d, Y') }}</span>
                                    </div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($project->price)
                                <div class="text-sm font-semibold text-gray-900">₹{{ number_format($project->price / 100000, 1) }}L</div>
                                @if($project->area)
                                    <div class="text-xs text-gray-500">{{ $project->area }}</div>
                                @endif
                            @else
