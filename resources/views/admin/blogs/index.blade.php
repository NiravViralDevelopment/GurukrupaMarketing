                ...
                <div class="text-white">
                    ...
                    <div class="flex items-center space-x-6 text-white/80">
                        <div class="flex items-center space-x-2">
                            ...
                            <span>{{ $blogs->count() }} Total Posts</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.922-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path>
                            </svg>
                            <span>{{ $blogs->where('is_featured', true)->count() }} Featured</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $blogs->count() }}</p>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $blogs->where('status', 'published')->count() }}</p>
                    </div>
                </div>
                <div class="text-right">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $blogs->where('status', 'draft')->count() }}</p>
                    </div>
                </div>
                <div class="text-right">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $blogs->where('is_featured', true)->count() }}</p>
                    </div>
                </div>
                <div class="text-right">
                    ...
                    <tr class="hover:bg-gradient-to-r hover:from-gray-50 hover:to-gray-100 transition-all duration-300 group">
                            ...
                            <div class="flex items-center space-x-6">
                                <div class="flex-shrink-0">
                                    @if($blog->featured_image)
                                        <div class="h-16 w-16 rounded-2xl overflow-hidden shadow-lg group-hover:shadow-xl transition-shadow duration-300">
                                            <img class="h-full w-full object-cover group-hover:scale-105 transition-transform duration-300" src="{{ Storage::url($blog->featured_image) }}" alt="{{ $blog->title }}">
                                        </div>
                                    @else
                                ...
                                <div class="min-w-0 flex-1">
                                    <div class="flex items-center space-x-3 mb-2">
                                        <h4 class="text-lg font-bold text-gray-900 truncate group-hover:text-primary transition-colors duration-200">{{ $blog->title }}</h4>
                                        @if($blog->is_featured)
                                    ...
                                    <p class="text-sm text-gray-600 truncate mb-2">{{ Str::limit($blog->excerpt, 80) }}</p>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($blog->published_at)
                                <div class="text-sm text-gray-900">{{ $blog->published_at->format('M d, Y') }}</div>
                        ...
                        <td class="px-8 py-6 whitespace-nowrap text-center">
                            <div class="flex items-center justify-center space-x-3">
                                ...
                                <button onclick="toggleFeatured({{ $blog->id }}, {{ $blog->is_featured ? 'false' : 'true' }})" 
                                        ...
                                        title="{{ $blog->is_featured ? 'Remove from Featured' : 'Add to Featured' }}">
                                    <svg class="w-5 h-5 group-hover:scale-110 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"></path>
                                    </svg>
                                </button>
