        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <img src="{{ $banner->image_url }}" alt="{{ $banner->title }}" class="w-32 h-24 object-cover rounded-lg border">
                    <div>
            ...
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                    {{ $banner->image ? 'New Banner Image (Optional)' : 'Banner Image' }}
                    ...
                    <div class="space-y-1 text-center">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="image" class="relative cursor-pointer bg-white rounded-md font-medium text-primary hover:text-yellow-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary">
                                ...
                                <input id="image" name="image" type="file" class="sr-only" accept="image/*" {{ !$banner->image ? 'required' : '' }}>
                            </label>
