    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="flex items-center">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="{{ route('admin.projects.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium">View All →</a>
            </div>
    </div>
        ...
        <div class="flex items-center">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="{{ route('admin.projects.index') }}?status=active" class="text-green-600 hover:text-green-800 text-sm font-medium">View Active →</a>
            </div>
    </div>
        ...
        <div class="flex items-center">
            ...
            <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $stats['total_blogs'] }}</p>
                    </div>
                </div>
                <div class="text-right">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="{{ route('admin.blogs.index') }}" class="text-yellow-600 hover:text-yellow-800 text-sm font-medium">View All →</a>
            </div>
        </div>
        ...
        <div class="group bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-1">{{ $stats['new_inquiries'] }}</p>
                    </div>
                </div>
                <div class="text-right">
            ...
            <div class="mt-4 flex items-center justify-between">
                ...
                <a href="{{ route('admin.inquiries.index') }}?status=new" class="text-red-600 hover:text-red-800 text-sm font-medium">View New →</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="px-6 py-4 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500">{{ $stats['new_inquiries'] }} new</span>
                            </div>
                        </div>
        </div>
        <div class="p-6">
                            ...
                            <div class="group flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-300">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        <p class="font-semibold text-gray-900 truncate">{{ $inquiry->name }}</p>
                                        <p class="text-sm text-gray-600 truncate">{{ $inquiry->email }}</p>
                                        <p class="text-xs text-gray-500 mt-1">{{ Str::limit($inquiry->message, 40) }}</p>
                                    </div>
                    </div>
                    ...
                    <div class="px-6 py-4 border-b border-gray-100">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm text-gray-500">{{ $stats['active_projects'] }} active</span>
                            </div>
                        </div>
        </div>
        <div class="p-6">
                            ...
                            <div class="group flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-all duration-300">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <p class="text-sm text-gray-600 truncate">{{ $project->location }}</p>
