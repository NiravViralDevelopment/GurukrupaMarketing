...
<section class="relative h-96 bg-cover bg-center" 
         style="background-image: url('{{ $project->primaryImage() ? $project->primaryImage()->image_url : ($project->images->first() ? $project->images->first()->image_url : 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80') }}')">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="aspect-w-16 aspect-h-9">
                            <img src="{{ $image->image_url }}" alt="{{ $image->alt_text ?: $project->title }}" class="w-full h-64 object-cover rounded-lg hover:scale-105 transition-transform duration-300 cursor-pointer" onclick="openImageModal('{{ $image->image_url }}', '{{ $image->alt_text ?: $project->title }}')">
                        </div>
                        @endforeach
                    </div>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                ...
                @endphp
                <div class="h-48 bg-cover bg-center" style="background-image: url('{{ $relatedProjectImage }}')"></div>
                <div class="p-6">
