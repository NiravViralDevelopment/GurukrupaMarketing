...
@section('title', 'Blog - ' . ($settings['site_name'] ?? 'Gurukrupa Real Estate'))
@section('description', 'Read our latest blog posts about real estate trends, home buying tips, and construction insights from Gurukrupa Real Estate.')
                ...
                <article class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between">
                            <a href="{{ route('blogs.show', $blog) }}" class="text-primary font-semibold hover:text-yellow-600 transition duration-300">
                                Read More
