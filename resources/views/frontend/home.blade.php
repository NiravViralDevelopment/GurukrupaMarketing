...
<section class="relative h-screen bg-cover bg-center bg-no-repeat" style="background-image: url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1973&q=80')">
    ...
    <div class="relative z-10 flex items-center justify-center h-full">
        <div class="text-center text-white px-4">
            ...
            <div class="space-x-4">
                <a href="{{ route('projects.index') }}" class="bg-primary text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-yellow-600 transition duration-300 inline-block">Explore Projects</a>
                <a href="{{ route('contact') }}" class="border-2 border-white text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white hover:text-gray-900 transition duration-300 inline-block">Get Quote</a>
            </div>
        </div>
    </div>
</section>
...
<section class="py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="{{ route('projects.show', $project) }}" class="text-primary hover:text-yellow-600 transition duration-300">View Details →</a>
                    </div>
                </div>
            </div>
            @endforeach
        ...
        <div class="text-center mt-12">
            <a href="{{ route('projects.index') }}" class="bg-primary text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-yellow-600 transition duration-300">View All Projects</a>
        </div>
    </div>
</section>
...
<section class="py-20 bg-primary">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white">
            ...
            <div>
                <div class="text-5xl font-bold mb-2">{{ $stats['completed_projects'] }}+</div>
                <div class="text-xl">Happy Customers</div>
            </div>
            <div>
                <div class="text-5xl font-bold mb-2">{{ $stats['ongoing_projects'] }}+</div>
...
<section class="py-20 bg-gray-900 text-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a href="{{ route('contact') }}" class="bg-primary text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-yellow-600 transition duration-300">Contact Us Today</a>
    </div>
</section>
@endsection
