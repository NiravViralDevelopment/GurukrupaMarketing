    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-72 bg-gray-900 text-white flex-shrink-0 hidden lg:block">
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('admin.banners.index') }}" class="flex items-center px-6 py-3 text-gray-300 hover:bg-gray-800 hover:text-white {{ request()->routeIs('admin.banners.*') ? 'bg-gray-800 text-white' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="bg-white shadow-sm border-b flex-shrink-0">
                <div class="flex items-center justify-between px-4 lg:px-6 py-4">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl lg:text-2xl font-semibold text-gray-900 truncate">@yield('page-title', 'Dashboard')</h1>
                    </div>
                    
                    <div class="flex items-center space-x-2 lg:space-x-4 flex-shrink-0">
                        <span class="text-gray-600 text-sm lg:text-base hidden sm:block">Welcome, {{ Auth::user()->name }}</span>
