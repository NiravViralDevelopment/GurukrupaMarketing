                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            value="{{ old('email') }}"
                            class="input-focus block w-full pl-10 pr-3 py-3 border border-white/20 rounded-lg bg-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 @error('email') border-red-400 focus:border-red-400 @enderror" 
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            class="input-focus block w-full pl-10 pr-12 py-3 border border-white/20 rounded-lg bg-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 @error('password') border-red-400 focus:border-red-400 @enderror" 
