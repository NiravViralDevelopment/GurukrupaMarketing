...
<head>
    ...
    <title>Admin Login - Gurukrupa Real Estate</title>
    ...
    <div class="relative w-full max-w-md">
        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-8 backdrop-blur-lg">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto w-16 h-16 bg-primary rounded-full flex items-center justify-center mb-4 shadow-lg">
                    <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path>
                    </svg>
                </div>
                <h1 class="text-3xl font-bold text-white mb-2">Admin Login</h1>
                <p class="text-white/80 text-sm">Gurukrupa Real Estate Management</p>
            </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            class="input-focus block w-full pl-10 pr-3 py-3 border border-white/20 rounded-lg bg-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 <?php $__errorArgs = ['email'];
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            required 
                            class="input-focus block w-full pl-10 pr-12 py-3 border border-white/20 rounded-lg bg-white/10 text-white placeholder-white/60 focus:outline-none focus:ring-0 focus:border-primary transition-all duration-300 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 focus:border-red-400 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <button 
                    type="submit" 
                    id="submitBtn"
                    class="btn-hover w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-primary hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            <div class="mt-8 text-center">
                <p class="text-white/60 text-xs">
                    © <?php echo e(date('Y')); ?> Gurukrupa Real Estate. All rights reserved.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\Working\GurukrupaMarketing\resources\views/auth/login.blade.php ENDPATH**/ ?>