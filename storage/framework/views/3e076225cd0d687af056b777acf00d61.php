                ...
                <div class="flex items-start space-x-4">
                    <?php if($project->images->count() > 0): ?>
                        <div class="flex-shrink-0">
                            <img src="<?php echo e(asset($project->images->first()->image_path)); ?>" alt="<?php echo e($project->title); ?>" 
                                 class="h-20 w-20 rounded-xl object-cover shadow-md">
                        </div>
                    <?php endif; ?>
                    <div class="flex-1">
                        <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($project->title); ?></h1>
                        <div class="flex flex-wrap items-center gap-3 mb-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium
                                <?php if($project->category === 'new_launch'): ?> bg-blue-100 text-blue-800 border border-blue-200
                                <?php elseif($project->category === 'ongoing'): ?> bg-yellow-100 text-yellow-800 border border-yellow-200
                                <?php else: ?> bg-green-100 text-green-800 border border-green-200
                                <?php endif; ?>">
                        ...
                        <p class="text-gray-600 text-lg leading-relaxed"><?php echo e($project->short_description); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($project->location); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($project->area); ?></p>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900">₹<?php echo e(number_format($project->price / 100000, 1)); ?>L</p>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e($project->created_at->format('M d, Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center p-4 bg-blue-50 rounded-lg border border-blue-200">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-semibold text-blue-800"><?php echo e($project->start_date->format('F d, Y')); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center p-4 bg-green-50 rounded-lg border border-green-200">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-lg font-semibold text-green-800"><?php echo e($project->end_date->format('F d, Y')); ?></p>
                        </div>
                    </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                    ...
                    <div class="flex items-center p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                        ...
                        <span class="text-sm font-medium text-blue-800"><?php echo e(ucfirst(str_replace('_', ' ', $amenity))); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <?php $__currentLoopData = $project->images->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative group cursor-pointer" onclick="openLightbox('<?php echo e(asset($image->image_path)); ?>', '<?php echo e($image->alt_text); ?>')">
                        <img src="<?php echo e(asset($image->image_path)); ?>" alt="<?php echo e($image->alt_text); ?>" 
                ...
                <?php if($project->images->count() > 4): ?>
                <div class="mt-3 text-center">
                    <button onclick="openLightbox('<?php echo e(asset($project->images->first()->image_path)); ?>', '<?php echo e($project->images->first()->alt_text); ?>')" 
                            class="text-primary hover:text-yellow-600 text-sm font-medium">
                        View All <?php echo e($project->images->count()); ?> Images
                    </button>
                </div>
                <?php endif; ?>
                <?php else: ?>
                ...
                <div class="bg-gradient-to-r from-red-50 to-pink-50 p-4 rounded-lg border border-red-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($project->brochure); ?></p>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="bg-gray-100 rounded-lg h-48 flex items-center justify-center">
                    <div class="text-center">
                        ...
                        <p class="text-xs text-gray-400 mt-1">Coordinates: <?php echo e($project->map_lat); ?>, <?php echo e($project->map_lng); ?></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-900 mt-1"><?php echo e($project->meta_title); ?></p>
                    </div>
                    <?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-900 mt-1"><?php echo e($project->meta_description); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
