...
$(document).ready(function() {
    var table = $('#inquiriesTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.inquiries.index')); ?>",
            type: 'GET',
            data: function(d) {
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    if (data.mark_read) {
                        ...
                        actions += '<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">';
...
function loadStatistics() {
    ...
    fetch('<?php echo e(route("admin.inquiries.index")); ?>?stats=1')
...
function markAllAsRead() {
    if (confirm('Are you sure you want to mark all new inquiries as read?')) {
        fetch('<?php echo e(route("admin.inquiries.index")); ?>', {
            method: 'POST',
            headers: {
