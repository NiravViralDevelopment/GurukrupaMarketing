...
<?php $__env->startSection('title', 'About Us - ' . ($settings['site_name'] ?? 'Gurukrupa Real Estate')); ?>
<?php $__env->startSection('description', $settings['site_description'] ?? 'Learn about Gurukrupa Real Estate, a leading developer specializing in premium residential and commercial projects.'); ?>
    ...
    <div class="container mx-auto px-4">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="<?php echo e(route('projects.index')); ?>" class="bg-white text-primary px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-300">
                    View Our Projects
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-primary transition duration-300">
                    Get in Touch
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\GurukrupaMarketing\resources\views/frontend/about.blade.php ENDPATH**/ ?>