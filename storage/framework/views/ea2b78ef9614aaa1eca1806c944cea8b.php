...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?php echo e(route('admin.banners.create')); ?>" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-yellow-600 transition duration-300">
        Add New Banner
    </a>
</div>
...
$(document).ready(function() {
    $('#bannersTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('admin.banners.index')); ?>",
            type: 'GET'
        },
        columns: [
            {
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    if (data) {
                        return '<img src="' + data + '" alt="' + row.title + '" class="w-16 h-12 object-cover rounded">';
                    }
                ...
                render: function(data, type, row) {
                    return '<div class="flex items-center space-x-2">' +
                        ...
                        '<a href="' + data.edit + '" class="text-blue-600 hover:text-blue-900" title="Edit">' +
                            ...
                            '</svg>' +
                        '</a>' +
                        '<form method="POST" action="' + data.delete + '" class="inline" onsubmit="return confirm(\'Are you sure you want to delete this banner?\')">' +
                            '<?php echo csrf_field(); ?>' +
        ...
        order: [[2, 'desc']], // Sort by created_at desc by default
        pageLength: 10,
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Working\GurukrupaMarketing\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>