...
<section class="bg-gray-900 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-gray-300">Get in touch with us for your real estate needs</p>
    </div>
</section>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select id="project_id" name="project_id"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent <?php $__errorArgs = ['project_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
            ...
            <div>
                ...
                <div class="space-y-8">
                    <div class="flex items-start">
                        <div class="bg-primary w-12 h-12 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                    ...
                    <div class="flex items-start">
                        <div class="bg-green-500 w-12 h-12 rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                ...
                <div class="mt-8">
                    ...
                    <div class="bg-gray-200 h-64 rounded-lg flex items-center justify-center">
                        <p class="text-gray-500">Google Map will be displayed here</p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\GurukrupaMarketing\resources\views/frontend/contact.blade.php ENDPATH**/ ?>